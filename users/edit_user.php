...
<head>
    ...
    <style>
        ...
        .container {
            width: 400px;
            /* Tất cả các phần tử đều có chiều rộng tối đa 400px */
        ...
        select {
            width: 100%;
            /* Các ô nhập liệu và ô chọn đều có chiều rộng 100% */
            padding: 10px;
            margin-bottom: 20px;
            ...
            /* Đảm bảo padding và border không làm thay đổi chiều rộng */
        }

        .btn {
            width: 100%;
            /* Nút cũng có chiều rộng 100% */
            padding: 10px;
